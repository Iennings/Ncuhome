...
public class Login extends Activity implements View.OnClickListener{
    ...
    private RelativeLayout backMain1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backMain = (ImageView) findViewById(R.id.back_main2);
        backMain1 = (RelativeLayout) findViewById(R.id.login_back);
...
//        Toast.makeText(this, "" + message, Toast.LENGTH_SHORT).show();
        ...
        backMain1.setOnClickListener(this);
    }
    @Override
    public void onClick(View view) {
        if (view.getId() == R.id.login_back || view.getId() == R.id.back_main2) {
