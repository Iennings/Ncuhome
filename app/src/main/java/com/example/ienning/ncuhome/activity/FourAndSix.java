...
public class FourAndSix extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        使用setOnClickListener(this);可以很好的解决这个代码重复问题
         */
    ...
    public void login(final String username, final String password) {
        ...
        try {
            jsonObject.put("examid", username);
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    if (response.isSuccessful()) {
                        ...
                        if (status == 1) {
                            ...
                            editor.putString("CETexamid", username);
                            editor.putString("CETname", password);
                            editor.commit();
                            jsonAnalysis.parseJSONWithFour(responseStr);
                            ...
                            FourAndSix.this.runOnUiThread(new Runnable() {
                                @Override
                                public void run() {
                                    Toast.makeText(FourAndSix.this, "抱歉准考证号或姓名错误", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    }
